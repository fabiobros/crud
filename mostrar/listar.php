...
<h4> Listar Pessoas</h4>
    ...
    $result_pessoas = "Select * FROM pessoa LIMIT $inicio, $qnt_result_pg";
    $result_total_pessoas = mysqli_query($conn, $result_pessoas);
    foreach($result_total_pessoas as $row){

        echo "ID: "         . $row['id'] . "<br>";
        echo "Nome: "       . $row['nome'] . "<br>";
        echo "Celular: "    . $row['contato'] . "<br>";
        echo "Data Cadastro: "  . $row['data_cadastro'] . "<br>";
        echo "<a href='../edit/editar_pessoa.php?id=" . $row['id'] ."'>Editar</a><br>";
        echo "<a href='../delete/apagar_usuario.php?id=" . $row['id'] ."'>Deletar</a><br><hr>";
